...
export interface CompiledRouteDefinition extends BaseRouteDefinition {
    validationAndTransformation?: Schemas<ValidateFunction, ValidatorAndTransformer>;
}
export declare type ViewConverter<T extends AbstractViewModel = AbstractViewModel> = (view: T) => string;
...
export interface JsonSchemaAndTransformer<T extends AbstractViewModel = AbstractViewModel> {
    schema: JsonSchema;
